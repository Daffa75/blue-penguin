...
class FinalProjectStudentS1ApexChart extends ApexChartWidget
{
    /**
     * Chart Id
     *
     * @var string
     */
    protected static string $chartId = 'finalProjectStudentS1ApexChart';
     ...
     * @var string|null
     */
    protected static ?string $heading = 'Final Project Bachelor Graph';
